...
test("Slice 002 migration remains the unique additive migration after Slice 001", () => {
  ...
  assert.ok(
    migrations.indexOf("202609120001_generalize_business_job_invoice_completion.sql") <
      migrations.indexOf("202609160008_generalize_canonical_evaluation_job_sources.sql")
  );
