...
test("Slice 004 is one additive migration after Workstream foundation", () => {
  ...
  assert.equal(migrations.at(-4), "202608100001_create_workstream_activity_foundation.sql");
  assert.equal(migrations.at(-3), migrationName);
  assert.equal(migrations.at(-2), "202608100003_create_canonical_quote_scope_foundation.sql");
