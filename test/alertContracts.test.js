...
test("alert error codes remain internal and alert-specific", () => {
  ...
  assert.equal(ALERT_ERROR_CODES.INVALID_QUERY, "INVALID_ALERT_QUERY");
  assert.equal(ALERT_ERROR_CODES.INVALID_CURSOR, "INVALID_ALERT_CURSOR");
  assert.equal(ALERT_ERROR_CODES.INVALID_LIFECYCLE, "INVALID_ALERT_LIFECYCLE");
  assert.equal(ALERT_ERROR_CODES.FETCH_FAILED, "ALERTS_FETCH_FAILED");
  assert.equal(ALERT_ERROR_CODES.READ_ALL_FAILED, "ALERT_READ_ALL_FAILED");
});
